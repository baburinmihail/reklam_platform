  ...
  <header>
    <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
      ...
      <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        <a class="me-3 py-2 text-dark text-decoration-none" href="/admin">Админка</a>
      </nav>
    </div>
  ...
  <main>
    <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          <div class="card-header py-3 text-white bg-primary border-primary">
            <h4 class="my-0 fw-normal">Выданные ссылки</h4>
          </div>
          <div class="card-body">
            <h2 class="card-title pricing-card-title">{{ $count_zakaz }}<small class="text-muted fw-light"></small></h2>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          <div class="card-header py-3 text-white bg-primary border-primary">
            <h4 class="my-0 fw-normal">Кол-во переходов</h4>
          </div>
          <div class="card-body">
            <h2 class="card-title pricing-card-title">{{ $count_link }}<small class="text-muted fw-light"></small></h2>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          <div class="card-header py-3 text-white bg-primary border-primary">
            <h4 class="my-0 fw-normal">Отказы переходов</h4>
          </div>
          <div class="card-body">
            <h2 class="card-title pricing-card-title">{{ $block_link }}<small class="text-muted fw-light"></small></h2>
          </div>
        </div>
      </div>
    ...
    <div class="col">
      <div class="card mb-4 rounded-3 shadow-sm border-primary">
        <div class="card-header py-3 text-white bg-primary border-primary">
          <h4 class="my-0 fw-normal">Всего заработанно</h4>
        </div>
        <div class="card-body">
          <h2 class="card-title pricing-card-title">{{ $more_money }}<small class="text-muted fw-light"></small></h2>
        </div>
      </div>
    </div>
